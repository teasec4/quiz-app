You are acting as a Flutter implementation engineer.

Read project memory first:

spec/memory_bank/project_context.md
...
spec/features/{{feature}}/design.md
spec/features/{{feature}}/requirements.md

Then read the active task:

spec/tasks/active_task.md
