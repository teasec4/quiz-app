import 'package:bookexample/data/repositories/library_repository_impl.dart';
import 'package:bookexample/data/repositories/study_session_repository_impl.dart';
...
import 'package:bookexample/data/db_schema.dart';
...
Future<void> setupServiceLocator() async {
  ...
  getIt.registerSingleton<StatsRepository>(StatsRepositoryImpl(isar));
  getIt.registerSingleton<StudySessionRepository>(
    IsarStudySessionRepositoryImpl(isar),
  );
